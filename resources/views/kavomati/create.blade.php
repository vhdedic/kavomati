		...
		<div class="container">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Novi kavomat</h3>
				</div>
				<div class="panel-body">
					<form action="{{ route('kavomati.store')}}" method="POST">
						{{ csrf_field() }}
						<div class="form-group">
							<label for="naziv">Naziv kavomata</label>
							<input type="text" class="form-control" id="naziv" name="naziv" placeholder="Upišite naziva za kavomat">
						</div>
						<div class="form-group">
